...
<div class="max-w-sm rounded overflow-hidden shadow-xl">
    ...
    <div class="text-center pb-4">
        ...
        <div class="flex flex-col items-center space-y-2">
            <a href={`/produkter/${productId}`} data-sveltekit-preload-data class="underline">Läs mer</a>
            <a href={orderLink} target="_blank" data-sveltekit-preload-data class="border border-black px-8 py-2 text-sm rounded-sm hover:bg-blue-950 hover:text-white">Beställ</a>
        </div>
    </div>
</div>